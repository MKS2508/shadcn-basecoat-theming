...
export function getFileArea(filePath: string): string {
  const areas = [
    // Packages específicos del monorepo
    { pattern: /^packages\/theme-manager-core\//, area: 'core' },
    { pattern: /^packages\/template-engine\//, area: 'template-engine' },
    { pattern: /^packages\/theme-manager-vanilla\//, area: 'vanilla' },
    { pattern: /^packages\/theme-manager-react\//, area: 'react' },
    { pattern: /^packages\/theme-manager-astro\//, area: 'astro' },
    { pattern: /^packages\/theme-manager-web-components\//, area: 'web-components' },
    { pattern: /^packages\/theme-manager-init\//, area: 'cli' },
    
    // Áreas generales
    { pattern: /^src\/components\/|^src\/layouts\//, area: 'ui' },
    { pattern: /^src\/themes\/|theme|\.css$/, area: 'themes' },
    { pattern: /^examples\//, area: 'examples' },
    { pattern: /^src\/utils\/|utilities/, area: 'utils' },
    { pattern: /config|\.json$|\.toml$|package\.json|tsconfig|vite\.config/, area: 'config' },
    { pattern: /^project-utils\/|tools|scripts/, area: 'tools' },
    { pattern: /test|spec|\.test\.|\.spec\./, area: 'testing' },
    { pattern: /doc|readme|\.md$|CHANGELOG/, area: 'docs' },
    { pattern: /^\.github\//, area: 'ci' },
    { pattern: /shadcn|ui\//, area: 'ui-components' },
  ];
